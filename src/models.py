...
class User(db.Model):
    ...
    avatar = db.Column(db.String(200), default=app.config["DEFAULT_USER_IMG"], nullable=False)
...
class Van(db.Model):
    ...
    image = db.Column(db.String(200), default=app.config["DEFAULT_VANS_IMG"], nullable=False)
...
class Transaction(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    uuid = db.Column(db.UUID, unique=True, nullable=False)
    lessee_name = db.Column(db.String(40), unique=False, nullable=False)
    lessee_surname = db.Column(db.String(40), unique=False, nullable=False)
    lessee_email = db.Column(db.String(40), unique=False, nullable=False)
...
class Review(db.Model):
    ...
    van_name = db.Column(db.String(30), nullable=False, unique=False)  # this must NOT be a ForeignKey; must remain when Van is deleted
